...
SRC = buffers.c fatops.c fileops.c iec.c main.c errormsg.c doscmd.c ff.c fastloader.c m2iops.c d64ops.c diskchange.c eeprom.c parser.c utils.c timer.c
...
LONGVERSION := $(PROGRAMVERSION)-$(CONFIG_MCU:atmega%=m%)$(CONFIGSUFFIX)
